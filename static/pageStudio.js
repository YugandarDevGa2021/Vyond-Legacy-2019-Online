...
function loadLegacyPreview() {
    ...
    document.getElementById('playerdiv').innerHTML = '<iframe width="640" height="360" frameborder="0" allowfullscreen="1" src="/player?movieId=${params.flashvars.presaveId}"></iframe>';
    }
